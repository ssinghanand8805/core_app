    ...
    return Obx(() => RefreshIndicator(
          ...
          child: ListView(
            ...
            children: [
              ...
              Text(
                  '${TKeys.welcomeBack.tr}, ${auth.currentUser.value?.name ?? 'Admin'} 👋',
                  style: TextStyle(
              ...
              GridView.count(
                ...
                children: [
                  StatCard(
                      ...
                      value: ctrl.users.length.toString(),
                      icon: Icons.people_rounded,
                      color: const Color(0xFF00C9B1)),
                  StatCard(
                      label: TKeys.totalTrainers.tr,
                      value: ctrl.trainers.length.toString(),
                      icon: Icons.fitness_center_rounded,
                      color: const Color(0xFFFF6B35)),
                  StatCard(
                      label: TKeys.totalRevenue.tr,
                      value: '₹${ctrl.totalRevenue.toStringAsFixed(0)}',
                      icon: Icons.currency_rupee_rounded,
                      color: const Color(0xFF7C3AED)),
                  StatCard(
                      label: TKeys.activeSubsCount.tr,
                      value: ctrl.activeSubscriptions.toString(),
              ...
              Row(children: [
                ...
                TextButton(
                  ...
                  child: const Text('See All',
                      style: TextStyle(color: Color(0xFF00C9B1), fontSize: 12)),
                ),
              ]),
              const SizedBox(height: 8),
              ...ctrl.payments.take(3).map((p) => Container(
